                        ...
                        <ul class="navbar-nav ">
                            ...
                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <li><a class="donate" href="https://www.paypal.com/pools/c/8gMhCrFluG" style="background-color: rgba(0,0,0,0);"><i class='fas fa-donate' style='font-size:36px;color: deeppink'></i></a></li>
                                    <li class="nav-item">
