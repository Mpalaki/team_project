        ...
        <div class="container" style="margin-top:20px">
            <div class="card bg-light">
                ...
                <article id="art1" class="card-body mx-auto" style="max-width: 400px;">
                    ...
                    <form id="foid" action="savenewpass" enctype="multipart/form-data" method="post">
                        ...
                        <div class="form-group input-group">
                            ...
                            <input  name="iduser" class="form-control" hidden value="${iduser}">
                        </div> <!-- form-group// -->       
                        
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary btn-block"  id="disable"> Submit  </button>
                        </div> <!-- form-group// -->      
                    </form>
                </article>
