                                                                    ...
                                                                    <div class="tab-pane" id="edit">
                                                                        <form role="form">
                                                                            ...
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-lg-9">
                                                                                    <input class="form-control" name="emailAddress" type="email" placeholder="contact email">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label class="col-lg-3 col-form-label form-control-label">Facebook<br>( public information )</label>
                                                                                <div class="col-lg-9">
                                                                                    <input class="form-control" name="facebook" type="text" placeholder="URL path of FB profile (e.g 'https://www.facebook.com/makis.karfakis.1')">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label class="col-lg-3 col-form-label form-control-label">Instagram<br>( public information )</label>
                                                                                <div class="col-lg-9">
                                                                                    <input class="form-control" name="instagram" type="text" placeholder="URL path of FB profile (e.g 'https://www.facebook.com/makis.karfakis.1')">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label class="col-lg-3 col-form-label form-control-label">Twitter<br>( public information )</label>
                                                                                <div class="col-lg-9">
                                                                                    <input class="form-control" name="twitter" type="text" placeholder="URL path of FB profile (e.g 'https://www.facebook.com/makis.karfakis.1')">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                            ...
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <textarea class="col-lg-9" rows = "6" cols = "50" name = "aboutme">text area </textarea></br>
                                                                            </div>
                                                                            <div class="form-group row">
